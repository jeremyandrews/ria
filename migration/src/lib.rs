...
mod m20220101_000004_create_artist_table;
mod m20220101_000005_create_audioartist_table;
...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20220101_000004_create_artist_table::Migration),
            Box::new(m20220101_000005_create_audioartist_table::Migration),
        ]
    }
}
